...
PRODUCT_COPY_FILES += \
	...
	device/softwinner/airforce-evb/ril_modem/spreadwin/g3/hspa-pppd:system/etc/ppp/hspa-pppd \
	device/softwinner/airforce-evb/ril_modem/spreadwin/g3/libg3-ril.so:system/lib/libg3-ril.so

PRODUCT_COPY_FILES += \
	device/softwinner/airforce-evb/ril_modem/spreadwin/g3/init.spw_g3.rc:root/init.sun6i.3g.rc
