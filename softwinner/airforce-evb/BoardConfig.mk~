...
#
include device/softwinner/airforce-common/BoardConfigCommon.mk

# bt default config
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/softwinner/airforce-evb/bluetooth/

BLUETOOTH_USE_BTV := true

#recovery
TARGET_RECOVERY_UI_LIB := librecovery_ui_airforce_evb
