...
TARGET_BOARD_PLATFORM := airforce
...
TARGET_HARDWARE_INCLUDE := $(TOP)/device/softwinner/airforce-common/hardware/include

BOARD_SEPOLICY_DIRS := \
        device/softwinner/airforce-common/sepolicy
